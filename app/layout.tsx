...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={'${inter.className} pt-18 sm:pt-36  bg-gray-50 text-gray-950 relative h-[5000px]'}>
        <div className =" bg-[#d8f2e8] absolute top-[-5rem] right-[11rem] h-[31.25rem] w-[31.25rem] -z-10 rounded-full blur-[10rem] sm:w-[68.75rem]"></div>
